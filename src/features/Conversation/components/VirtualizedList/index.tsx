...
interface VirtualizedListProps {
  dataSource: string[];
  /**
   * Optional header content rendered above all chat items.
   *
   * Used, for example, to show the agent's opening message as the
   * first item in every topic.
   */
  header?: ReactNode;
...
const VirtualizedList = memo<VirtualizedListProps>(
  ({ mobile, dataSource, itemContent, header }) => {
