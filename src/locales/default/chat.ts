export default {
  ...
  agentDefaultMessage:
    '你好，我是 **{{name}}**，你可以立即与我开始对话，也可以前往 [角色设置]({{url}}) 完善我的信息。',
  ...
  confirmRemoveSessionItemAlert: '即将删除该角色，删除后该将无法找回，请确认你的操作',
  confirmRemoveSessionSuccess: '角色删除成功',
  defaultAgent: '自定义角色',
  defaultList: '默认列表',
  defaultSession: '自定义角色',
  duplicateSession: {
    loading: '复制中...',
    success: '复制成功',
    title: '{{title}} 副本',
  ...
  sessionGroup: {
    config: '分组管理',
    confirmRemoveGroupAlert: '即将删除该分组，删除后该分组的角色将移动到默认列表，请确认你的操作',
    createAgentSuccess: '角色创建成功',
    createGroup: '添加新分组',
