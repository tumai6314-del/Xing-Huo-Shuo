export default {
  ...
  danger: {
    clear: {
      action: '立即清除',
      confirm: '确认清除所有聊天数据？',
      desc: '将会清除所有会话数据，包括角色、文件、消息、插件等',
      success: '已清除所有会话消息',
      title: '清除所有会话消息',
    },
    reset: {
  ...
  settingOpening: {
    openingMessage: {
      desc: '打开会话时的开场消息，用来介绍角色的功能',
      placeholder: '你好，我是自定义角色。你可以立即与我开始对话，也可以前往角色设置完善我的信息。',
      title: '开场消息',
    },
    openingQuestions: {
      desc: '会话开始时展示的引导性问题',
  ...
  settingTTS: {
    ...
    voice: {
      desc: '为当前角色挑选一个声音，不同 TTS 服务支持的声源不同',
      preview: '试听声源',
      title: '语音合成声源',
    },
  },
  storage: {
    actions: {
      export: {
        ...
        exportType: {
          agent: '导出角色设定',
          agentWithMessage: '导出角色和消息',
          all: '导出全局设置和所有角色数据',
          allAgent: '导出所有角色设定',
          allAgentWithMessage: '导出所有角色和消息',
  ...
  submitAgentModal: {
    ...
    metaMiss: '请补全角色信息后提交，需要包含名称、描述和标签',
    placeholder: '请输入角色的标识符，需要是唯一的，比如 web-development',
    tooltips: '分享到角色市场',
  },
  submitFooter: {
    reset: '重置',
  ...
  systemAgent: {
    ...
    helpInfo: '当创建新角色时，将以默认角色设置作为预设值。',
    historyCompress: {
      label: '会话历史模型',
